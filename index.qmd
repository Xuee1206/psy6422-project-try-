...
```{r Plot1-trend}
# Animated version of Plot 1: reveal trends over time
happy_trend_anim <- ggplot(
  happy_focus,
  aes(x = Year, y = share_happy, colour = Entity, group = Entity)
) +
  ...
  labs(
    ...
    subtitle = "Animated: lines are drawn gradually over time",
    x = "Year",
  ...
  # This makes the lines appear over time
  transition_reveal(Year)

# Render animation in the HTML document
animate(
  happy_trend_anim,
  nframes = 120,
  fps = 15,
